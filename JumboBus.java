...
class BusPassenger
{
	...
	public BusPassenger(int bookingId, String destination, String tripPackage)
	{
...
class Exception_Assignment1_JumboBusService 
{
	...
	{
		BusPassenger booking = new BusPassenger(101,"Orlando", "Regular");
